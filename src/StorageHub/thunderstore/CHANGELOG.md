...
(titled Resupply) of items and counts to keep in the pack. The panel uses Items
and Recipes tabs; Items keeps search, categories, and sort, Recipes lists known
crafts and withdraws their ingredients when nearby chests have enough. A station
